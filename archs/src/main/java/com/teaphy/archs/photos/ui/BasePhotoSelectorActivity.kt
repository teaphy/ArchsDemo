...
import com.teaphy.archs.photos.config.PictureMimeType
...
abstract class BasePhotoSelectorActivity : BasePhotosActivity() {
	...
	private fun openCamera27(file: File, intent: Intent) {
		...
		val imageUri = FileProvider.getUriForFile(context, "com.teaphy.archs", file)//通过FileProvider创建一个content类型的Uri
